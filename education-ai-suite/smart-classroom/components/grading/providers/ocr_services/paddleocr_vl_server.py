...
async def lifespan(app: FastAPI):
    ...
    repetition_penalty = server_config['repetition_penalty']
...
def main():
    ...
    repetition_penalty = svc.get('repetition_penalty', 1.3)
    ...
    server_config['repetition_penalty'] = repetition_penalty
